...
void exibirArquivosGerados() {
    ...
    cout << "- resultados_benchmark.csv" << endl;
    cout << "- resultados_restricoes.csv" << endl;
    cout << "- comparacao_hash_otimizada.csv" << endl;
...
cout << "Arquivo resultados_restricoes.csv gerado." << endl;
cout << "\nParte 9 concluida com sucesso." << endl;
cout << "Cinco testes com restricoes implementados." << endl;
cout << "Arquivo resultados_restricoes.csv gerado." << endl;
...
cout << "Arquivo comparacao_hash_otimizada.csv gerado." << endl;
